...
import com.redevance.controller.MainController;
import com.redevance.controller.RegisterController;
import com.redevance.controller.SplashController;
import com.redevance.dao.bean.*;
import com.redevance.dao.dao.DAOFactory;
import com.redevance.dao.dao.DAOName;
import com.redevance.resources.lang.RessourceBundleSevices;
...
public class Main extends Application {
    ...
    public final static ObservableList<Categories> categories= FXCollections.observableArrayList();
    ...
    public final static ObservableList<Livres> livres=FXCollections.observableArrayList();
    public final static ObservableList<Ventes> ventes=FXCollections.observableArrayList();
    public final static ObservableList<Vente_details> ventelines=FXCollections.observableArrayList();
    public final static ObservableList<Clients> clients=FXCollections.observableArrayList();
...
//        primarystage.initStyle(StageStyle.TRANSPARENT);
        ...
        if(((SplashController)vb.getController()).isOk()) {
                if (DAOFactory.createModel(DAOName.user).selectAll().isEmpty()) {
